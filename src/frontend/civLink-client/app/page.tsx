  ...
  const testimonials = [
    {
      ...
      content: 'Grâce à CivLink, nous avons pu établir des partenariats avec 15 OSC dans la région et obtenir un financement de 90,000€ pour notre projet d\'alphabétisation numérique.',
    ...
    },
    {
      ...
      content: 'En 6 mois, nous avons trouvé 5 nouveaux bailleurs et formé 500 femmes entrepreneures grâce aux connexions établies sur CivLink.',
      image: 'https://images.pexels.com/photos/3184420/pexels-photo-3184420.jpeg'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            {/* <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-900">CivLink</span>
            </div> */}
            {/* Logo image */}
            <div className="flex items-center space-x-2">
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              {/* <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-lg font-bold">CivLink</span>
              </div> */}
              {/* Logo image */}
              <div className="flex items-center space-x-2 mb-4">
                <img src="/civLink-logo.png" alt="CivLink" className="h-8" />
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><Link href="/groups" className="hover:text-white transition-colors">Groupes thématiques</Link></li>
                <li><Link href="/resources" className="hover:text-white transition-colors">Ressources & Outils</Link></li>
                <li><Link href="/success-stories" className="hover:text-white transition-colors">Success Stories</Link></li>
                <li><Link href="/funders" className="hover:text-white transition-colors">Espace Bailleurs</Link></li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 CivLink. Tous droits réservés.</p>
          </div>
        </div>
      </footer>
    </div>
